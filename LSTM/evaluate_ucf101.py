...
save_path = "./ucf101-experiment/ucf101-baseline-lstm/rms-lr-0.001-decayr-0-decays-0-drop-0.7-init-gauss0.1/"
log_path = save_path + "evaluate_ucf101.log"
...
iterator_param = {'dataset': 'ucf101',
                  'data_file': '/home/zhenyang/Workspace/data/UCF101/features/rgb_vgg16_fc7',
                  'num_frames_file': '/home/zhenyang/Workspace/data/UCF101/train_framenum.txt',
                  'labels_file': '/home/zhenyang/Workspace/data/UCF101/train_labels.txt',
                  'vid_name_file': '/home/zhenyang/Workspace/data/UCF101/train_filenames.txt',
...
iterator_param = {'dataset': 'ucf101',
                  'data_file': '/home/zhenyang/Workspace/data/UCF101/features/rgb_vgg16_fc7',
                  'num_frames_file': '/home/zhenyang/Workspace/data/UCF101/test_framenum.txt',
                  'labels_file': '/home/zhenyang/Workspace/data/UCF101/test_labels.txt',
                  'vid_name_file': '/home/zhenyang/Workspace/data/UCF101/test_filenames.txt',
...
############################# interface layer
param = {"id": "ucf101-vgg16-fc7", "use_mask": True,
...
param = {'interface_layer': interface_layer, 'middle_layers': middle_layers, 'cost_layer': cost_layer,
         ...
         'name': "UCF101-VideoModel-LSTM-RMS",
...
param = {'id': '1', 'learning_rate': 0.001, 'momentum': 0.9, 'decay_rate': 0.9, 'clip_threshold': None, 'verbose': False,
         'max_epoch': 200, 'start_epoch': 0, 'valid_epoch': 20, 'max_epochs_no_best': 200, 'decay_step': 200,
